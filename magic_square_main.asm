...
get_sqr_size proc
	...
	mov		sqr_size, eax                  ; and moves it into the 32-bit variable holding the size
...
test_if_magic proc
	...
	vpbroadcastd    zmm10{k1}{z}, xmm0
	
	vpcmpeqd   k3, zmm0, zmm10
	vpcmpeqd   k4, zmm1, zmm10
